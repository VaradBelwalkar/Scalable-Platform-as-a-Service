...
try:
    ...
    r1 = client.get(base_url + "deploy/nodejs/")
    ...
    subprocess.run(["{}/bin/services/deploy_nodejs.sh".format(projectPath),"{}".format(projectPath),"{}".format(sys.argv[1]),"{}".format(sshPortNo),"{}".format(data['ipAddr'])])
