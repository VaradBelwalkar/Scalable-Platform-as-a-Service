...
try:
    ...
    r1 = client.get(base_url + "deploy/django/{}".format(getpass.getuser()))
    ...
    subprocess.run(["{}/bin/services/deploy_django.sh".format(projectPath),"{}".format(projectPath),"{}".format(sys.argv[1]),"{}".format(sshPortNo),"{}".format(data['ipAddr'])])
